        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{$settingsOpening??''}} {{$settingsOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item aboutSettings">
                <a href="{{@url('/admin/settings/about-us')}}" class="nav-link  {{$aboutSettings??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>About US</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{@url('/admin/settings/services')}}" class="nav-link  {{$serviceSettings??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Services</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/settings/portfolio')}}" class="nav-link {{$portfolioSettings??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Portfolio</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/settings/support')}}" class="nav-link {{$supportSettings??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Support</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$blogOpening??''}} {{$blogOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{@url('/admin/blogs/create')}}" class="nav-link {{$blogCreateActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$teamOpening??''}} {{$teamOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{@url('/admin/team/create')}}" class="nav-link {{$teamCreateActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$testimonialsOpening??''}} {{$testimonialsOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{@url('/admin/testimonials')}}" class="nav-link {{$testimonialsListActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/testimonial/create')}}" class="nav-link {{$testimonialsCreateActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$faqsOpening??''}} {{$faqsOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{@url('/admin/faq-heads')}}" class="nav-link {{$faqHeadListActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Heads</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$caseStudyOpening??''}} {{$caseStudyOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{@url('/admin/case-studies')}}" class="nav-link {{$caseStudyListActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/case-study/create')}}" class="nav-link {{$caseStudyCreateActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New</p>
                </a>
              </li>
          ...
          <li class="nav-item {{$partnersOpening??''}} {{$partnersOpend??''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{@url('/admin/partners')}}" class="nav-link {{$partnersListActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/partner/create')}}" class="nav-link {{$partnersCreateActive??''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
