      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="{{@url('/admin/partner/save')}}" enctype="multipart/form-data">
                <div class="card-body">
                @csrf
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="company_name" value="{{ old('company_name') }}" class="form-control" id="company_name" placeholder="Enter Company Name">
                      @error('company_name')
  ...
  $('#quickForm').validate({
    ...
    messages: {
      company_name: {
        ...
        minlength: "Company name should be greater than 3 chars."
      },
      image: {
